...
urlpatterns = [
    ...
    path("user_projects/<int:id>", views.projects_by_user, name='projects_by_user'),
    path("project_by_id/<int:id>", views.project_by_id, name='project_by_id'),
    ...
    path("comments_by_item/<int:id>", views.comments_by_item, name='comments_by_item'),
